<template>
  <div class="d-flex justify-content-between">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>Auths</el-breadcrumb-item>
    </el-breadcrumb>
    <el-button
      plain
      type="info"
      size="small"
      @click="$router.push('/auths/authority-groups/auths/' + this.$route.params.auths_id + '/create')"
      >Add</el-button
    >
  </div>
          ...
          <el-dropdown trigger="click">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item
                  @click="
                    $router.push('/auths/authority-groups/auths/' + this.$route.params.auths_id + '/detail/' + scope.row.id)
                  "
                ...
                <el-dropdown-item
                  @click="
                    $router.push('/auths/authority-groups/auths/' + this.$route.params.auths_id + '/edit/' + scope.row.id)
                  "
                  class="text-decoration-none text-primary"
                >
                  Edit
