<template>
  <el-breadcrumb separator="/">
    ...
    <el-breadcrumb-item :to="{ path: '/auths/tables-group/tables/list' }">Tables</el-breadcrumb-item>
...
export default {
  ...
  mounted() {
    services.edit("tables", this.$route.params.id).then((res) => {
  ...
  methods: {
    save() {
      services.update("tables", this.data.id, this.data).then(() => {
        ElNotification({
          title: "Success",
          message: "Updated",
          type: "success",
