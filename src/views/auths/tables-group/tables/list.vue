<template>
  <div class="d-flex justify-content-between">
    ...
    <el-button plain size="small" type="info" @click="$router.push('/auths/tables-group/tables/create')">Add</el-button>
  </div>
  ...
  <el-table :data="datas.data" style="width: 100%">
    <template v-for="column in datas.columns" :key="column.name">
      <template
        ...
        "
      ></template>
      <el-table-column v-else :key="column.name" :prop="column.name" min-width="250px" width="auto">
        <template #header>
