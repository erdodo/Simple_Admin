  ...
  <div>
    <div class="d-flex justify-content-between">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>Ürünler</el-breadcrumb-item>
      </el-breadcrumb>
      <el-button plain size="small" type="info" @click="$router.push('/market/create')">Add</el-button>
    </div>
      ...
      <el-table-column fixed="right" label="Operations" min-width="118">
        <template #default="scope">
          <div class="d-flex justify-content-center w-100">
            <el-button type="" class="me-1" @click="(visible = true), (odeme_id = scope.row.id)">Form</el-button>
            <el-dropdown trigger="click">
              <el-button><i class="bi bi-pencil fs-6"></i></el-button>
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item>
                    <router-link class="text-decoration-none text-primary" :to="'/market/detail/' + scope.row.id"
                      >Detail</router-link
                    >
                  </el-dropdown-item>
                  <el-dropdown-item>
                    <router-link class="text-decoration-none text-success" :to="'/market/edit/' + scope.row.id"
                      >Edit</router-link
                    >
                  </el-dropdown-item>
    ...
    <odeme-formu v-model:visible="visible" :id="odeme_id"></odeme-formu>
  </div>
</template>
...
import OdemeFormu from "./odeme-formu.vue";
export default {
  data() {
    return {
      datas: {},
